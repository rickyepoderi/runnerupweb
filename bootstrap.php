...
require_once __DIR__ . '/common/TagManager.php';
...
require_once __DIR__ . '/common/AutomaticTag.php';
require_once __DIR__ . '/common/autotags/SportActivityAutomaticTag.php';
require_once __DIR__ . '/common/autotags/RegexNotesAutomaticTag.php';
require_once __DIR__ . '/common/autotags/RouteAutomaticTag.php';
require_once __DIR__ . '/common/autotags/LocationAutomaticTag.php';
require_once __DIR__ . '/common/autotags/AverageSpeedAutomaticTag.php';
require_once __DIR__ . '/common/autotags/DistanceAutomaticTag.php';

// data
require_once __DIR__ . '/data/Activity.php';
require_once __DIR__ . '/data/ActivityLap.php';
require_once __DIR__ . '/data/ActivityTrackpoint.php';
require_once __DIR__ . '/data/LoginResponse.php';
require_once __DIR__ . '/data/User.php';
require_once __DIR__ . '/data/Tag.php';
require_once __DIR__ . '/data/TagConfig.php';
...
require_once __DIR__ . '/data/TagListResponse.php';
require_once __DIR__ . '/data/TagConfigResponse.php';
